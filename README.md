...
<head>
    ...
    <title>RC Full Slots Database</title>
    <style>
        :root {
            --bg: #2c3e50;
        ...
        body { 
            ...
            background: linear-gradient(135deg, #1e2a38 0%, #3b5284 100%);
        ...
        .header-box h2 { color: var(--gold); text-shadow: 2px 2px 4px rgba(0,0,0,0.5); margin: 0; }

        .search-wrapper { width: 100%; max-width: 900px; margin-bottom: 15px; }
        #searchInput { 
            width: 100%; padding: 15px; border: none; border-radius: 10px; 
            font-size: 16px; box-shadow: 0 4px 15px rgba(0,0,0,0.3); outline: none;
        }
        ...
        th { background: rgba(0,0,0,0.6); padding: 12px; font-size: 0.8em; text-transform: uppercase; color: var(--gold); }
        td { padding: 10px 8px; text-align: center; border-bottom: 1px solid rgba(255,255,255,0.05); font-size: 0.85em; }
        ...
        .story-row { background: rgba(255, 255, 255, 0.1); font-weight: bold; color: var(--gold); }
        .story-row td { text-align: left; padding-left: 15px; letter-spacing: 1px; }

        .code-text { font-family: 'Consolas', monospace; color: var(--code-text); word-break: break-all; font-weight: bold; display: block; margin-bottom: 5px; }
        
        .copy-btn {
            background: #27ae60; color: white; border: none; padding: 5px 12px; 
            border-radius: 4px; cursor: pointer; font-size: 0.7em; transition: 0.3s;
        }
        .copy-btn:hover { background: #2ecc71; }
        .copy-btn.copied { background: #3498db; }

        .info-txt { font-size: 0.75em; opacity: 0.7; font-style: italic; }
...
<div class="header-box">
    <h2>💎 ПОЛНАЯ БАЗА СЛОТОВ</h2>
</div>

<div class="search-wrapper">
    <input type="text" id="searchInput" onkeyup="filterData()" placeholder="Поиск по имени, истории или параметрам (Гнев, Вера, Логика)...">
</div>
...
<div class="table-container">
    <table id="mainTable">
        ...
        <tbody>
            ...
            <tr><td>Мэт (2т)</td><td><span class="code-text">cf48199c00acd80a0a96ad72fe8544dc</span><button class="copy-btn" onclick="copyCode(this)">Копировать</button></td><td class="info-txt">рассуждение</td></tr>
            ...
            <tr><td>Мент</td><td><span class="code-text">d1f1d2190a7a331a0bdaa0554c94b</span><button class="copy-btn" onclick="copy(this)">Копировать</button></td><td class="info-txt">2с 5с, путь баланса</td></tr>
            ...
            <tr><td>Лео</td><td><span class="code-text">3b443ca263066aaa1caef0f9ef433b93</span><button class="copy-btn" onclick="copy(this)">Копировать</button></td><td class="info-txt">человек, финал</td></tr>
            ...
            <tr><td>Новак</td><td><span class="code-text">17c10046c34b928a54e042c492114ad2</span><button class="copy-btn" onclick="copy(this)">Копировать</button></td><td class="info-txt">морок, сострадание, выс.связь</td></tr>
            ...
            <tr><td>Кристиан</td><td><span class="code-text">fc0df0d7263064c4e7fdf459954876bf</span><button class="copy-btn" onclick="copy(this)">Копировать</button></td><td class="info-txt">наследие, гордость, конец 2с</td></tr>
            ...
            <tr><td>Сара</td><td><span class="code-text">eb7401a112bb8bffd554c25121a24ab6</span><button class="copy-btn" onclick="copy(this)">Копировать</button></td><td class="info-txt">наследие, гордость, 2с 7с</td></tr>
            ...
            <tr><td>Амрит</td><td><span class="code-text">1520ec77e59ed379751d2f150f50a736</span><button class="copy-btn" onclick="copy(this)">Копировать</button></td><td class="info-txt">милость, лояльность</td></tr>
            ...
            <tr class="story-row"><td colspan="3">Остальное</td></tr>
            <tr><td>Минхёк (ЭС)</td><td><span class="code-text">4f03e11a86304a1fd884dfb12c7d827d</span><button class="copy-btn" onclick="copy(this)">Копировать</button></td><td class="info-txt">амбиции, попса</td></tr>
            <tr><td>Кас (ЭС)</td><td><span class="code-text">f1ad1c34f9ecdf9f19f731e409c0d5dd</span><button class="copy-btn" onclick="copy(this)">Копировать</button></td><td class="info-txt">амбиции, попса</td></tr>
            ...
            <tr><td>Сэм (ЯОНТ1)</td><td><span class="code-text">ea9c827a062eb5c3bb6fff106c738d85</span><button class="copy-btn" onclick="copy(this)">Копировать</button></td><td class="info-txt">логика</td></tr>
        </tbody>
    </table>
</div>
    ...
    function filterData() {
        ...
        for (let i = 1; i < rows.length; i++) {
            ...
            if (row.classList.contains('story-row')) {
                // Если у предыдущей истории были совпадения, оставляем её заголовок
                if (lastStoryRow) lastStoryRow.style.display = storyHasMatch ? "" : "none";
                
                lastStoryRow = row;
                storyHasMatch = false;
                row.style.display = "none"; // Скрываем по умолчанию
                continue;
            }
            ...
            if (text.includes(input)) {
                row.style.display = "";
                storyHasMatch = true;
                if (lastStoryRow) lastStoryRow.style.display = ""; // Показываем заголовок
            } else {
                row.style.display = "none";
            }
        }
        // Проверка для последней группы
        if (lastStoryRow) lastStoryRow.style.display = storyHasMatch ? "" : "none";
    }
</script>
